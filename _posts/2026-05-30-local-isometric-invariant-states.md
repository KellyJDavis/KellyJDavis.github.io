...
$$
>
> where $$\varphi(\mathbf{B})$$ is the image of the basis element $$\mathbf{B}$$ under the isometry $$\varphi$$ and $$\alpha_\varphi$$ is a unital *-isomorphism generated by $$\varphi$$ that satisfies for the identity $$\mathbf{1}$$
>
> $$
> \alpha_{\mathbf{1}}(a) = a
> $$
...
Now that we've defined what seems like a "natural" notion of a global isometric invariant state on Minkowski spacetime, the next question to ask is if such states even exist. This is, unfortunately, a difficult question.
